...
console.log("".concat(spaceShuttle.name, " has ").concat(spaceShuttle.getDaysToLocation(kilometersToMars), " more days until arriving on Mars."));
console.log("".concat(spaceShuttle.name, " has ").concat(spaceShuttle.getDaysToLocation(kilometersToTheMoon), " more days until arriving on Mars."));
